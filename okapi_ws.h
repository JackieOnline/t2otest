...
private:
public:
    static void RequestWithoutLogin(std::string url, std::string channels, std::string op, void(*on_msg)(std::string timestamp));
    ...
    static void SubscribeWithoutLogin(std::string url, std::string channels, void(*on_msg)(std::string timestamp));
